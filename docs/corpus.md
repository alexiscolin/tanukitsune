...
today: the rules that judge a sound anchor, an allocation and a meaning story against what the
character is made of are written and tested, and the command that puts them in front of a generated
