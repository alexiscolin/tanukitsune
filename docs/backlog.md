...
| A settings screen | none | The first surface that stores anything about a reader beyond a session: language, theme, hint default, timer and length. v0.1 keeps its two settings where the session starts rather than opening this. |
