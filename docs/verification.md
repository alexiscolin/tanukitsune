...
| `subjects` | pull request | the title, every authored commit subject on the branch, merges excepted since nothing writes theirs, and a description carrying the plan |
