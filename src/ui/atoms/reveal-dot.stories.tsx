...
const meta = {
  component: RevealDot,
  args: { copy: copyFor('fr').subject, onReveal: () => {} },
...
export const Waiting: Story = { args: { revealed: false, listens: false } }
...
export const Spent: Story = { args: { revealed: true, listens: false } }
